...
import org.w3c.dom.NodeList;
    ...
    public class Ejercicio7 {
            ...
            return new JMenuItem(new AbstractAction("Start") {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    if (xmlDocument != null) {
                        ...
                        logTextArea.append(contPasos + " - Has comenzado en la habitacion " + firstRoom.getAttributes().getNamedItem("id").getNodeValue() + "\n");
        ...
        private static void getLogMessage() {
			Color bg = new Color(197, 209, 235);
			logTextArea.setBackground(bg);
			logTextArea.setLineWrap(true);
			logTextArea.setWrapStyleWord(true);
			logTextArea.setFont(fontPlusFour(logTextArea.getFont()));
            logTextArea.setText("Hola! Este es tu log, donde se registraran tus movimientos por la mazmorra!\n");
                    ...
                    try {
                        ...
                        if (xmlDocument != null) {
                            ...
                            if (xmlDocument.getFirstChild().getNodeName().equals("dungeon")) {
                                ...
                                // AUMENTAMOS LA FUENTE DEL ARBOL
								//newJt.setForeground(Color.WHITE);
