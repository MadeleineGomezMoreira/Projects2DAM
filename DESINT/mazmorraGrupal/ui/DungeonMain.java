...
public class DungeonMain {
    ...
    /*
    *   JMazmorraTree (){} pinta el tree
    *   JMazmorraNavigation (){} pinta los botones
    *   Modelos:
    *       Door: nombre, destino
    *       Room: id, List<Door>, description
    *
    *
    *   JMazmorraLog (){} le llega mensaje y el lo pinta en el textArea log
    *   XMLMazmorraLoader (){} elige (archivos xml) y carga el archivo devuelve la lista de nodos
    *
    * */
